...
{
    if (!_menuArray1) {
        _menuArray1 = @[@"*业务员",@"*经办银行",@"*业务发生地",@"*汽车经销商",@"*公司归口",@"*购车途径"];
    }
    return _menuArray1;
}
...
-(NSArray *)menuSecondgHandArray1
{
    if (!_menuSecondgHandArray1) {
        _menuSecondgHandArray1 = @[@"*业务员",@"*经办银行",@"*业务发生地",@"*汽车经销商",@"*购车途径",@"*品牌",@"*车系",@"*车型"];
    }
...
-(NSArray *)menuArray4usedCar
{
    if (!_menuArray4usedCar) {
        _menuArray4usedCar = @[@"*贷款本金",
                        @"*贷款期数",
                        @"*银行利率",
                        @"*总利率%",
                        @"*返存利率%",
...
{
    if (!_homeArray) {
        _homeArray = @[@"准入资料",@"准入审核",@"确认评估",@"接受评估",@"用款申请",@"用款审核",@"制单回录",@"垫资回录",@"理件",@"打件",@"银行收件",@"银行提交",@"录入放款",@"确认收款",@"发送抵押",@"确认抵押",@"入档",@"GPS申请",@"GPS审核"];
    }
    return _homeArray;
}
