...
@interface AddTaskExecutorVC ()<UITableViewDelegate,UITableViewDataSource,RefreshDelegate>
@property (nonatomic,strong) NSMutableArray<SurveyModel *> * model;
@property (nonatomic,strong) TLTableView * tableview;
@end

@implementation AddTaskExecutorVC
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = self.model[indexPath.row].realName;
    return cell;
