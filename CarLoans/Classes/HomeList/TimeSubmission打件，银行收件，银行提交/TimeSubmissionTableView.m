...
@interface TimeSubmissionTableView ()<UITableViewDataSource,UITableViewDelegate>



@end
@implementation TimeSubmissionTableView
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    cell.placeHolderLabel.text = self.right;
    return cell;
}
