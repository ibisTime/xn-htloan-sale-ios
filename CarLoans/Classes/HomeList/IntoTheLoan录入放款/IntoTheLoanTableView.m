...
@interface IntoTheLoanTableView ()<UITableViewDataSource,UITableViewDelegate>



@end
@implementation IntoTheLoanTableView
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        if (indexPath.row == 2) {
            cell.rightStr = self.repayBankDate;
        }else
        {
            cell.rightStr = self.repayBillDate;
        }
