...
//  CarLoans
//
//  Created by shaojianfei on 2018/10/8.
//  Copyright © 2018年 QinBao Zheng. All rights reserved.
//

#import "GPSInfomationCell.h"

@implementation GPSInfomationCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        if (k == 14) {
            UIView *lineView2 = [[UIView alloc]initWithFrame:CGRectMake(0, 279+70+90+90+10, SCREEN_WIDTH, 1)];
            ...
            _button.frame = CGRectMake(SCREEN_WIDTH - 115, 290+60+90+90+30-20, 100, 30);
            kViewBorderRadius(_button, 5, 1, MainColor);
            [self addSubview:_button];
            _button.hidden = YES;
        }
        if (k == 11) {
            UIView *lineView2 = [[UIView alloc]initWithFrame:CGRectMake(0, 279+70+90+10, SCREEN_WIDTH, 1)];
            lineView2.backgroundColor = LineBackColor;
            [self addSubview:lineView2];
            _button = [UIButton buttonWithTitle:@"确认提交银行" titleColor:MainColor backgroundColor:kClearColor titleFont:15];
            _button.frame = CGRectMake(SCREEN_WIDTH - 115, 290+60+90+30-20, 100, 30);
            kViewBorderRadius(_button, 5, 1, MainColor);
            [self addSubview:_button];
            _button.hidden = YES;
        }else{
            ...
            [self addSubview:lineView2];
            _button = [UIButton buttonWithTitle:@"确认提交银行" titleColor:MainColor backgroundColor:kClearColor titleFont:15];
            _button.frame = CGRectMake(SCREEN_WIDTH - 115, 290+90-20, 100, 30);
            kViewBorderRadius(_button, 5, 1, MainColor);
            [self addSubview:_button];
            _button.hidden = YES;
        }
