...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        UILabel *nameLbl = [UILabel labelWithFrame:CGRectMake(15, 15, (SCREEN_WIDTH - 107)/2 - 15, 16.5) textAligment:(NSTextAlignmentLeft) backgroundColor:kClearColor font:Font(12) textColor:kHexColor(@"#333333")];
        nameLbl.tag = 1000;
//        nameLbl.text = [NSString stringWithFormat:@"第%@期",self.dic[@"curPeriods"]];
        [self addSubview:nameLbl];
        
        
        UILabel *timeLbl = [UILabel labelWithFrame:CGRectMake(15, nameLbl.yy + 4, (SCREEN_WIDTH - 107)/2 - 15, 16.5) textAligment:(NSTextAlignmentLeft) backgroundColor:kClearColor font:Font(12) textColor:kHexColor(@"#999999")];
        timeLbl.tag = 2000;
//        timeLbl.text = [self.dic[@"repayDatetime"] convertDate];
        [self addSubview:timeLbl];
        
        UILabel *priceLbl = [UILabel labelWithFrame:CGRectMake((SCREEN_WIDTH - 107)/2, 0, (SCREEN_WIDTH - 107)/2 - 15, 67) textAligment:(NSTextAlignmentRight) backgroundColor:kClearColor font:Font(14) textColor:kHexColor(@"#333333")];
//        NSString *price = [NSString stringWithFormat:@"%.2f元",[self.dic[@"repayAmount"] floatValue] / 1000 ];
        priceLbl.tag = 3000;
...
//        priceLbl.attributedText = attrString;
        ...
        UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(15, 66, (SCREEN_WIDTH - 107) - 30, 1)];
