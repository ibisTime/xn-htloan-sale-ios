...
//    }
    ...
    NSArray *bottomArray = @[[BaseModel convertNull:[NSString stringWithFormat:@"%@",[self.model.bizType isEqualToString:@"1"]?@"二手车":@"新车" ]],
                             ...
                             [BaseModel convertNullWithOutMoney:[NSString stringWithFormat:@"%.2f",[self.model.carInfoRes[@"originalPrice"] floatValue]/1000]],
                             [BaseModel convertNullWithOutMoney:[NSString stringWithFormat:@"%.2f",[self.model.loanInfo[@"sfAmount"] floatValue]/1000]],
                             [BaseModel convertNullWithOutMoney:[NSString stringWithFormat:@"%@",self.model.loanInfo[@"sfRate"]]],
                             [BaseModel convertNullWithOutMoney:[NSString stringWithFormat:@"%.2f", [self.model.loanInfo[@"loanAmount"] floatValue]/1000]],
                             ...
                             [BaseModel convertNullWithOutMoney:[NSString stringWithFormat:@"%.2f",[self.model.loanInfo[@"gpsFee"] floatValue]/1000]],
                             ...
                             [BaseModel convertNullWithOutMoney:[NSString stringWithFormat:@"%.2f",[self.model.carInfoRes[@"oilSubsidy"] floatValue]/1000]],
                             [BaseModel convertNullWithOutMoney:[NSString stringWithFormat:@"%.2f",[self.model.carInfoRes[@"carDealerSubsidy"] floatValue]/1000]],
