...
@interface GPSHomeVC ()<UIScrollViewDelegate>
...
@property (nonatomic, strong)GPSInstallationVC *vc1;
@property (nonatomic, strong)GPSNotInstallVC *vc2;
...
- (void)setupChildViewControll{
    self.vc1 = [[GPSInstallationVC alloc]init];
    self.vc2 = [[GPSNotInstallVC alloc]init];
    //指定该控制器为其子控制器
...
- (void)setupPageButton{
    ...
    UIButton *btn = [self setupButtonWithTitle:@"已安装" Index:0];
    [self setupButtonWithTitle:@"未安装" Index:1];
