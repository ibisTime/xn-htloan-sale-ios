...
@interface SurveyVC ()<UIScrollViewDelegate>
...
@property (nonatomic, strong)SurveyTGVC *vc1;
@property (nonatomic, strong)SurveyWTGVC *vc2;
...
- (void)setupChildViewControll{
    self.vc1 = [[SurveyTGVC alloc]init];
    self.vc2 = [[SurveyWTGVC alloc]init];
...
- (void)setupPageButton{
    ...
    UIButton *btn = [self setupButtonWithTitle:@"已通过" Index:0];
    [self setupButtonWithTitle:@"未通过" Index:1];
