...
-(void)setPicArray:(NSArray *)picArray
{
    ...
    for (int i = 0; i < picArray.count; i ++) {
        ...
        UIImageView *photoImage = [[UIImageView alloc]initWithFrame:CGRectMake(15 + i % 2 *  ((SCREEN_WIDTH - 40)/2 + 10), 50 + i / 3 * ((SCREEN_WIDTH - 50)/3 + 10), (SCREEN_WIDTH - 50)/3, (SCREEN_WIDTH - 40)/2)];
