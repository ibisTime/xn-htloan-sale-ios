...
@interface InsideSureHomeVC ()<UIScrollViewDelegate>
...
@property (nonatomic, strong)CarSettledInVC *vc1;
@property (nonatomic, strong)CarSettledInVC *vc2;
...
@implementation InsideSureHomeVC
