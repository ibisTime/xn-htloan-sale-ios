...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        cell.nameText = @"";
        NSArray *detailsArray = @[[BaseModel convertNull:self.model.creditUser[@"userName"]],
                                  [BaseModel convertNull:self.model.code]];
    ...
    if (indexPath.section == 4) {
        ...
        if (!cell) {
            ...
            cell.detailsStr = [NSString stringWithFormat:@"%.2f",[self.model.originalPrice floatValue]/1000];
        }
        cell.name = @"*厂商指导价(元)";
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
