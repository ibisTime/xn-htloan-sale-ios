...
@interface HomeTbView ()<UITableViewDelegate,UITableViewDataSource,HomeCellDelegate>
{
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([dataDic[@"roleCode"] isEqualToString:@"SR20180000000000000ZHRY"]) {
        ...
        HomeCell *cell = [tableView cellForRowAtIndexPath:indexPath]; //根据indexPath准确地取出一行，而不是从cell重用队列中取出
        if (cell == nil) {
