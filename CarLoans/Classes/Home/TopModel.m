...
{
    if (!_ary1) {
        _ary1 = @[@"*贷款银行",@"*贷款期限",@"银行利率",@"*贷款金额",@"*贷款产品",@"*GPS费用",@"*公证费用",@"*首付金额",@"*首付比例",@"*是否融资",@"*是否垫资",@"*是否安装GPS",@"*是否我司续保",@"*月供保证金",@"*服务费",@"*其他费用",@"*开票价"];
    }
    return _ary1;
}
...
{
    if (!_ary2) {
        _ary2 = @[@"*业务类型",@"*机动车销售公司",@"*开票单位",@"*开票价格",@"*车辆类型",@"*车辆品牌",@"*车辆车系",@"*车辆车型",@"*车辆颜色",@"*车架号",@"*发动机号",@"*市场指导价",@"*所属区域",@"*厂家贴息",@"*油补公里数",@"油补（元）",@"*落户地点"];
    }
    return _ary2;
}
