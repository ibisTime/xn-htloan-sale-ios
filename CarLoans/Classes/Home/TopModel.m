...
{
    if (!_ary1) {
        _ary1 = @[@"*贷款银行",@"*贷款期限",@"银行利率",@"*贷款金额",@"*贷款产品",@"*年化利率",@"*GPS费用",@"*公证费用",@"*返点利率",@"*前置利率",@"*首付金额",@"*首付比例",@"*是否融资",@"*是否垫资",@"*是否安装GPS",@"*是否我司续保",@"*月供保证金",@"*服务费",@"*其他费用",@"*开票价"];
    }
    return _ary1;
}
...
{
    if (!_ary2) {
        _ary2 = @[@"*业务类型",@"*机动车销售公司",@"*开票单价",@"*开票价格",@"*车辆类型",@"*车辆品牌",@"*车辆车系",@"*车辆车型",@"*车辆颜色",@"*车架号",@"*发动机号",@"*市场指导价",@"*所属区域",@"*厂家贴息",@"*油补公里数",@"油补（元）",@"*落户地点"];
    }
    return _ary2;
}
...
{
    if (!_ary5) {
        _ary5 = @[@"所属行业",@"*单位经济性质",@"*工作单位名称",@"*工作单位地址",@"工作单位电话",@"何时进入该单位",@"职务",@"*月收入",@"工作描述及还款来源分析",@"员工数量",@"企业月产值"];
    }
    return _ary5;
}
