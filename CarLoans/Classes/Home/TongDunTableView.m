...
@interface TongDunTableView()<UIGestureRecognizerDelegate,UITableViewDelegate,UITableViewDataSource>{
    NSMutableArray *_isExpandArray;//记录section是否展开
}
@end

@implementation TongDunTableView
...
//    UILabel *Label = [[UILabel alloc]initWithFrame:CGRectMake(40, 0, SCREEN_WIDTH  - 40 - 15, 60)];
